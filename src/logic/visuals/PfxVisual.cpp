...
void Logic::PfxVisual::onUpdate(float deltaTime)
{
    ...
    float ppsModTotal = m_Emitter.ppsIsSmooth ? bx::lerp(ppsMod1, ppsMod2, ppsKeyFrac) : ppsMod1;
...
void Logic::PfxVisual::spawnParticle()
{
    ...
    float shpModTotal = m_Emitter.ppsIsSmooth ? bx::lerp(shpMod1, shpMod2, shpKeyFrac) : shpMod1;
